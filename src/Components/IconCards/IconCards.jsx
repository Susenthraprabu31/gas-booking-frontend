  ...
  const iconCards = [
    {
      ...
      title: "Reliability",
      paragraph:
        "Our system is designed to minimize overbooking and guarantee.Plesant Energy ensures that users can count on their booked gas slots being available when they arrive. ",
    },
    {
    ...
    },
    {
      ...
      paragraph:
        "Plesant Energy offers real-time updates on gas station availability, wait times, and booking confirmations. This ensures users have the most accurate information.",
    },
    {
      icon: "fa-solid fa-shield text-primary px-2",
      title: "Safety and Hygiene",
      paragraph:
        "PlesantEnergy partners with gas stations that adhere to the highest safety and hygiene standards. This ensures a clean and secure environment for users.",
    },
    {
    ...
    },
    {
      ...
      paragraph:
        "Plesant Energy offers transparent pricing, with no hidden fees or unexpected charges. Users can trust that the price they see is the price they pay.",
    },
  ];
